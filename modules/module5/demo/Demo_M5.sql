...
--   Vuelo AV100 | Bogotá (BOG) → Miami (MIA) | 15 marzo 2026
--   Aeronave: Boeing 737 | Capacidad: 162 asientos
--   Situación: 2 pasajeros con reserva confirmada
--     1 hacen check-in y abordan correctamente
--     1 hacen check-in pero NO se presentan (no-shows)
...
-- Esto sirve para limpiar el escenario de prueba y dejarlo listo para la siguiente ejecución del test
